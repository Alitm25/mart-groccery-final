        ...
        <Modal closeModal={closeModal} title={'Confirm Logout'}>
            <div className={'flex flex-col items-center justify-center gap-y-11'}>
                ...
                <div className={'flex items-center justify-evenly w-full'}>
                    ...
                    <button onClick={() => {clearBasket(), closeModal()} } className={'rounded-xl border-2 border-green-300 text-green-300 hover:bg-green-300 hover:text-white hover:border-white font-quicksand font-bold text-lg md:py-4 md:px-[38px] py-4 px-7  transition-all'}>
                        Yes
                    </button>
                </div>
            </div>
