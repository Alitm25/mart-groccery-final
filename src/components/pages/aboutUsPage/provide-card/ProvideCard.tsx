...
export function ProvideCard({icon, title, description}: Props) {
    return (
        <div className={'border border-[#E5E5E5] hover:border-green-300 rounded-xl py-12 px-8 flex flex-col items-center justify-center gap-y-7 bg-white transition-all'}>
