...
function ProductCardButton({productData}: Props) {
    ...
    return (
        <div className="add-product">
            {
                basketItem ?
                    <div className={'border-[1px] font-quicksand font-bold text-xl rounded-[4px] border-green-300 text-green-300 h-full py-2 w-16 md:w-28 flex flex-row-reverse justify-evenly items-center'}>
