            ...
            <Section>
                    ...
                    <div className="flex gap-[24px]">
                        <div
                            ...
                            <Link href={'#'} className={'mt-6 pl-[15px] pr-2.5 py-2 bg-yellow-100 hover:bg-green-200 transition-[background-color] rounded-[3px] cursor-pointer inline-flex max-w-max items-center gap-2.5'}>
